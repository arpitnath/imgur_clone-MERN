...
class App extends Component {
 constructor(props) {
  ...
  componentDidMount = () => {
    ...
    window.addEventListener("load",() => {
     ...
     if(window.location.pathname === "/additem"){
       // we can hide the additem option on the menu
  ...
  componentWillUnmount(){
    const check = this.unlistenHistory()
  ...
  render() {
    ...
    if(showAddItem !== "/additem"){
      addItem =  <li id="additem"><Link to="/additem">Add Imgur</Link></li>
    }
